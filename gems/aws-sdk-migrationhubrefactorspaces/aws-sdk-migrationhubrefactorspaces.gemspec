...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-migrationhubrefactorspaces'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Migration Hub Refactor Spaces'
  spec.description   = 'Official AWS Ruby gem for AWS Migration Hub Refactor Spaces. This gem is part of the AWS SDK for Ruby.'
