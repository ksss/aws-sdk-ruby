...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-marketplaceagreement'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Agreement Service'
  spec.description   = 'Official AWS Ruby gem for AWS Marketplace Agreement Service (Agreement Service). This gem is part of the AWS SDK for Ruby.'
