...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-savingsplans'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWSSavingsPlans'
  spec.description   = 'Official AWS Ruby gem for AWS Savings Plans (AWSSavingsPlans). This gem is part of the AWS SDK for Ruby.'
