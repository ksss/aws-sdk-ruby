...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-dataexchange'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Data Exchange'
  spec.description   = 'Official AWS Ruby gem for AWS Data Exchange. This gem is part of the AWS SDK for Ruby.'
