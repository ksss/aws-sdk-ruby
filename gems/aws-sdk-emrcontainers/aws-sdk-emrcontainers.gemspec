...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-emrcontainers'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon EMR Containers'
  spec.description   = 'Official AWS Ruby gem for Amazon EMR Containers. This gem is part of the AWS SDK for Ruby.'
