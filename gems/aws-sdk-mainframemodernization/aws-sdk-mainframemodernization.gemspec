...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-mainframemodernization'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWSMainframeModernization'
  spec.description   = 'Official AWS Ruby gem for AWSMainframeModernization. This gem is part of the AWS SDK for Ruby.'
