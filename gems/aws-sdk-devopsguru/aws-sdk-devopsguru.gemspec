...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-devopsguru'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon DevOps Guru'
  spec.description   = 'Official AWS Ruby gem for Amazon DevOps Guru. This gem is part of the AWS SDK for Ruby.'
