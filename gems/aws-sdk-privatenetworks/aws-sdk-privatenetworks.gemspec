...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-privatenetworks'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Private 5G'
  spec.description   = 'Official AWS Ruby gem for AWS Private 5G. This gem is part of the AWS SDK for Ruby.'
