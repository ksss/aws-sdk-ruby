...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-supportapp'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - SupportApp'
  spec.description   = 'Official AWS Ruby gem for AWS Support App (SupportApp). This gem is part of the AWS SDK for Ruby.'
