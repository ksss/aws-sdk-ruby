...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-honeycode'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Honeycode'
  spec.description   = 'Official AWS Ruby gem for Amazon Honeycode (Honeycode). This gem is part of the AWS SDK for Ruby.'
