...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-connectcontactlens'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Connect Contact Lens'
  spec.description   = 'Official AWS Ruby gem for Amazon Connect Contact Lens. This gem is part of the AWS SDK for Ruby.'
