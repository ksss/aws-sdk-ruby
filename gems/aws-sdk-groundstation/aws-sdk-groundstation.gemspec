...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-groundstation'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Ground Station'
  spec.description   = 'Official AWS Ruby gem for AWS Ground Station. This gem is part of the AWS SDK for Ruby.'
