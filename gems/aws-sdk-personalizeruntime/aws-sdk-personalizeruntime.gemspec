...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-personalizeruntime'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Personalize Runtime'
  spec.description   = 'Official AWS Ruby gem for Amazon Personalize Runtime. This gem is part of the AWS SDK for Ruby.'
