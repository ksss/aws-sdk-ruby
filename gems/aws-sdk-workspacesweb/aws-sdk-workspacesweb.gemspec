...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-workspacesweb'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon WorkSpaces Web'
  spec.description   = 'Official AWS Ruby gem for Amazon WorkSpaces Web. This gem is part of the AWS SDK for Ruby.'
