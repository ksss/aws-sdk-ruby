...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-managedgrafana'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Managed Grafana'
  spec.description   = 'Official AWS Ruby gem for Amazon Managed Grafana. This gem is part of the AWS SDK for Ruby.'
