...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-bedrockagent'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Agents for Amazon Bedrock'
  spec.description   = 'Official AWS Ruby gem for Agents for Amazon Bedrock. This gem is part of the AWS SDK for Ruby.'
