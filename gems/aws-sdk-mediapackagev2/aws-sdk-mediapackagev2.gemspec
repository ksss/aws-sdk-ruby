...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-mediapackagev2'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - mediapackagev2'
  spec.description   = 'Official AWS Ruby gem for AWS Elemental MediaPackage v2 (mediapackagev2). This gem is part of the AWS SDK for Ruby.'
