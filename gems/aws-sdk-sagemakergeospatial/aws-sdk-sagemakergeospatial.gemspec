...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-sagemakergeospatial'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon SageMaker geospatial capabilities'
  spec.description   = 'Official AWS Ruby gem for Amazon SageMaker geospatial capabilities. This gem is part of the AWS SDK for Ruby.'
