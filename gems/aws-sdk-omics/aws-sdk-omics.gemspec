...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-omics'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Omics'
  spec.description   = 'Official AWS Ruby gem for Amazon Omics. This gem is part of the AWS SDK for Ruby.'
