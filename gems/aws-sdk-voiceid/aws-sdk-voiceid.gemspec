...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-voiceid'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Voice ID'
  spec.description   = 'Official AWS Ruby gem for Amazon Voice ID. This gem is part of the AWS SDK for Ruby.'
