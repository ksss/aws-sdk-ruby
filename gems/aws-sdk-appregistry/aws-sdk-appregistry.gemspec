...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-appregistry'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AppRegistry'
  spec.description   = 'Official AWS Ruby gem for AWS Service Catalog App Registry (AppRegistry). This gem is part of the AWS SDK for Ruby.'
