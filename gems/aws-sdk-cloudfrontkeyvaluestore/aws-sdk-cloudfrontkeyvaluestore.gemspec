...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-cloudfrontkeyvaluestore'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon CloudFront KeyValueStore'
  spec.description   = 'Official AWS Ruby gem for Amazon CloudFront KeyValueStore. This gem is part of the AWS SDK for Ruby.'
