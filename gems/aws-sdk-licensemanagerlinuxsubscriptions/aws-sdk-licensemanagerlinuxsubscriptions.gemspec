...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-licensemanagerlinuxsubscriptions'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS License Manager Linux Subscriptions'
  spec.description   = 'Official AWS Ruby gem for AWS License Manager Linux Subscriptions. This gem is part of the AWS SDK for Ruby.'
