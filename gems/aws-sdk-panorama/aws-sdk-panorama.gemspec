...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-panorama'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Panorama'
  spec.description   = 'Official AWS Ruby gem for AWS Panorama (Panorama). This gem is part of the AWS SDK for Ruby.'
