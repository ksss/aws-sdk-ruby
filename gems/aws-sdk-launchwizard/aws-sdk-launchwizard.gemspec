...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-launchwizard'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Launch Wizard'
  spec.description   = 'Official AWS Ruby gem for AWS Launch Wizard. This gem is part of the AWS SDK for Ruby.'
