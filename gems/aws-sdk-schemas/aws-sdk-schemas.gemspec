...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-schemas'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Schemas'
  spec.description   = 'Official AWS Ruby gem for Schemas. This gem is part of the AWS SDK for Ruby.'
