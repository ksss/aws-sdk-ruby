...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-snowdevicemanagement'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Snow Device Management'
  spec.description   = 'Official AWS Ruby gem for AWS Snow Device Management. This gem is part of the AWS SDK for Ruby.'
