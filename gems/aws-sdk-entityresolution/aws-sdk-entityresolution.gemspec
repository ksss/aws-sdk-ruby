...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-entityresolution'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWSEntityResolution'
  spec.description   = 'Official AWS Ruby gem for AWS EntityResolution (AWSEntityResolution). This gem is part of the AWS SDK for Ruby.'
