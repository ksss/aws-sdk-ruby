...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-arczonalshift'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS ARC - Zonal Shift'
  spec.description   = 'Official AWS Ruby gem for AWS ARC - Zonal Shift. This gem is part of the AWS SDK for Ruby.'
