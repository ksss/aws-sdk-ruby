...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-iotfleetwise'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS IoT FleetWise'
  spec.description   = 'Official AWS Ruby gem for AWS IoT FleetWise. This gem is part of the AWS SDK for Ruby.'
