...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-qbusiness'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - QBusiness'
  spec.description   = 'Official AWS Ruby gem for QBusiness. This gem is part of the AWS SDK for Ruby.'
