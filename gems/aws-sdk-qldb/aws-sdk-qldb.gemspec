...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-qldb'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - QLDB'
  spec.description   = 'Official AWS Ruby gem for Amazon QLDB (QLDB). This gem is part of the AWS SDK for Ruby.'
