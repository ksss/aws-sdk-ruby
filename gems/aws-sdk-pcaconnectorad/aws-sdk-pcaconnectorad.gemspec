...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-pcaconnectorad'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - PcaConnectorAd'
  spec.description   = 'Official AWS Ruby gem for PcaConnectorAd. This gem is part of the AWS SDK for Ruby.'
