...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-mediapackagevod'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - MediaPackage Vod'
  spec.description   = 'Official AWS Ruby gem for AWS Elemental MediaPackage VOD (MediaPackage Vod). This gem is part of the AWS SDK for Ruby.'
