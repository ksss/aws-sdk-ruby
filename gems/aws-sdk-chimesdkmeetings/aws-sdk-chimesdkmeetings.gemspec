...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-chimesdkmeetings'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Chime SDK Meetings'
  spec.description   = 'Official AWS Ruby gem for Amazon Chime SDK Meetings. This gem is part of the AWS SDK for Ruby.'
