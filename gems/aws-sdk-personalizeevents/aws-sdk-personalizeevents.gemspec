...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-personalizeevents'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Personalize Events'
  spec.description   = 'Official AWS Ruby gem for Amazon Personalize Events. This gem is part of the AWS SDK for Ruby.'
