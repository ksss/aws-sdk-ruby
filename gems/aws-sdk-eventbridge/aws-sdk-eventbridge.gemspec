...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-eventbridge'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon EventBridge'
  spec.description   = 'Official AWS Ruby gem for Amazon EventBridge. This gem is part of the AWS SDK for Ruby.'
