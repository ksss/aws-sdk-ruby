...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-managedblockchain'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - ManagedBlockchain'
  spec.description   = 'Official AWS Ruby gem for Amazon Managed Blockchain (ManagedBlockchain). This gem is part of the AWS SDK for Ruby.'
