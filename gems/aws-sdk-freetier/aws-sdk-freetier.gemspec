...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-freetier'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Free Tier'
  spec.description   = 'Official AWS Ruby gem for AWS Free Tier. This gem is part of the AWS SDK for Ruby.'
