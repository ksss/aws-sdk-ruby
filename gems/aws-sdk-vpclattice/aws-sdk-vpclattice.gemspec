...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-vpclattice'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon VPC Lattice'
  spec.description   = 'Official AWS Ruby gem for Amazon VPC Lattice. This gem is part of the AWS SDK for Ruby.'
