...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-b2bi'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS B2BI'
  spec.description   = 'Official AWS Ruby gem for AWS B2B Data Interchange (AWS B2BI). This gem is part of the AWS SDK for Ruby.'
