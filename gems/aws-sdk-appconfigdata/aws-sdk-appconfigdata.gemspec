...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-appconfigdata'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS AppConfig Data'
  spec.description   = 'Official AWS Ruby gem for AWS AppConfig Data. This gem is part of the AWS SDK for Ruby.'
