...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-eksauth'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon EKS Auth'
  spec.description   = 'Official AWS Ruby gem for Amazon EKS Auth. This gem is part of the AWS SDK for Ruby.'
