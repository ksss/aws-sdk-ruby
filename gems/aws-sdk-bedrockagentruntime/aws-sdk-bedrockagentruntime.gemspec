...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-bedrockagentruntime'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Agents for Amazon Bedrock Runtime'
  spec.description   = 'Official AWS Ruby gem for Agents for Amazon Bedrock Runtime. This gem is part of the AWS SDK for Ruby.'
