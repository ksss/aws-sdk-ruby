...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-ssmsap'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - SsmSap'
  spec.description   = 'Official AWS Ruby gem for AWS Systems Manager for SAP (SsmSap). This gem is part of the AWS SDK for Ruby.'
