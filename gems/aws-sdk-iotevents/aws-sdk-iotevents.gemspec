...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-iotevents'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS IoT Events'
  spec.description   = 'Official AWS Ruby gem for AWS IoT Events. This gem is part of the AWS SDK for Ruby.'
