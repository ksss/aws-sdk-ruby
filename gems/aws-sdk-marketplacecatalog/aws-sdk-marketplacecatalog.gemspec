...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-marketplacecatalog'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Marketplace Catalog'
  spec.description   = 'Official AWS Ruby gem for AWS Marketplace Catalog Service (AWS Marketplace Catalog). This gem is part of the AWS SDK for Ruby.'
