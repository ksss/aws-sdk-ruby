...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-route53recoverycluster'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Route53 Recovery Cluster'
  spec.description   = 'Official AWS Ruby gem for Route53 Recovery Cluster. This gem is part of the AWS SDK for Ruby.'
