...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-managedblockchainquery'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Managed Blockchain Query'
  spec.description   = 'Official AWS Ruby gem for Amazon Managed Blockchain Query. This gem is part of the AWS SDK for Ruby.'
