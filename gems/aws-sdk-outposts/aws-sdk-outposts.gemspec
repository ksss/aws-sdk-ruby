...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-outposts'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Outposts'
  spec.description   = 'Official AWS Ruby gem for AWS Outposts (Outposts). This gem is part of the AWS SDK for Ruby.'
