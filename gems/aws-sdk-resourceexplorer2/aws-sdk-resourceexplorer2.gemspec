...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-resourceexplorer2'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Resource Explorer'
  spec.description   = 'Official AWS Ruby gem for AWS Resource Explorer. This gem is part of the AWS SDK for Ruby.'
