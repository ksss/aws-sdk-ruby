...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-frauddetector'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Fraud Detector'
  spec.description   = 'Official AWS Ruby gem for Amazon Fraud Detector. This gem is part of the AWS SDK for Ruby.'
