...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-fis'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - FIS'
  spec.description   = 'Official AWS Ruby gem for AWS Fault Injection Simulator (FIS). This gem is part of the AWS SDK for Ruby.'
