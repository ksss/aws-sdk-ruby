...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-paymentcryptography'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Payment Cryptography Control Plane'
  spec.description   = 'Official AWS Ruby gem for Payment Cryptography Control Plane. This gem is part of the AWS SDK for Ruby.'
