...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-bcmdataexports'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Billing and Cost Management Data Exports'
  spec.description   = 'Official AWS Ruby gem for AWS Billing and Cost Management Data Exports. This gem is part of the AWS SDK for Ruby.'
