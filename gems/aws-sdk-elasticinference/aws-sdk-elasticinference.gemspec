...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-elasticinference'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Elastic Inference'
  spec.description   = 'Official AWS Ruby gem for Amazon Elastic  Inference (Amazon Elastic Inference). This gem is part of the AWS SDK for Ruby.'
