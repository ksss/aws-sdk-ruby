...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-imagebuilder'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - imagebuilder'
  spec.description   = 'Official AWS Ruby gem for EC2 Image Builder (imagebuilder). This gem is part of the AWS SDK for Ruby.'
