...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-macie2'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Macie 2'
  spec.description   = 'Official AWS Ruby gem for Amazon Macie 2. This gem is part of the AWS SDK for Ruby.'
