...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-detective'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Detective'
  spec.description   = 'Official AWS Ruby gem for Amazon Detective. This gem is part of the AWS SDK for Ruby.'
