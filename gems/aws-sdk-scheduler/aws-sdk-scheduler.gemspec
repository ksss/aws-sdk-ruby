...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-scheduler'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon EventBridge Scheduler'
  spec.description   = 'Official AWS Ruby gem for Amazon EventBridge Scheduler. This gem is part of the AWS SDK for Ruby.'
