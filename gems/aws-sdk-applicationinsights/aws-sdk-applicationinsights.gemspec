...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-applicationinsights'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Application Insights'
  spec.description   = 'Official AWS Ruby gem for Amazon CloudWatch Application Insights (Application Insights). This gem is part of the AWS SDK for Ruby.'
