...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-inspectorscan'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - inspector-scan'
  spec.description   = 'Official AWS Ruby gem for Inspector Scan (inspector-scan). This gem is part of the AWS SDK for Ruby.'
