...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-forecastservice'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Forecast Service'
  spec.description   = 'Official AWS Ruby gem for Amazon Forecast Service. This gem is part of the AWS SDK for Ruby.'
