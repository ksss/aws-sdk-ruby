...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-networkfirewall'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Network Firewall'
  spec.description   = 'Official AWS Ruby gem for AWS Network Firewall (Network Firewall). This gem is part of the AWS SDK for Ruby.'
