...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-augmentedairuntime'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Augmented AI Runtime'
  spec.description   = 'Official AWS Ruby gem for Amazon Augmented AI Runtime. This gem is part of the AWS SDK for Ruby.'
