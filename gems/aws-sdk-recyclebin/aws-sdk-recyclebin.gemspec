...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-recyclebin'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Recycle Bin'
  spec.description   = 'Official AWS Ruby gem for Amazon Recycle Bin. This gem is part of the AWS SDK for Ruby.'
