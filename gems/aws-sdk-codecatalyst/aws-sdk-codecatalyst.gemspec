...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-codecatalyst'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon CodeCatalyst'
  spec.description   = 'Official AWS Ruby gem for Amazon CodeCatalyst. This gem is part of the AWS SDK for Ruby.'
