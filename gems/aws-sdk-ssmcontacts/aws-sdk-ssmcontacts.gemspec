...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-ssmcontacts'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - SSM Contacts'
  spec.description   = 'Official AWS Ruby gem for AWS Systems Manager Incident Manager Contacts (SSM Contacts). This gem is part of the AWS SDK for Ruby.'
