...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-cloudtraildata'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS CloudTrail Data Service'
  spec.description   = 'Official AWS Ruby gem for AWS CloudTrail Data Service. This gem is part of the AWS SDK for Ruby.'
