...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-lookoutmetrics'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - LookoutMetrics'
  spec.description   = 'Official AWS Ruby gem for Amazon Lookout for Metrics (LookoutMetrics). This gem is part of the AWS SDK for Ruby.'
