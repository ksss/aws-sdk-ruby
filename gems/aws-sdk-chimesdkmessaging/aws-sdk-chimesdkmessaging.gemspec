...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-chimesdkmessaging'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Chime SDK Messaging'
  spec.description   = 'Official AWS Ruby gem for Amazon Chime SDK Messaging. This gem is part of the AWS SDK for Ruby.'
