...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-kendraranking'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Kendra Ranking'
  spec.description   = 'Official AWS Ruby gem for Amazon Kendra Intelligent Ranking (Kendra Ranking). This gem is part of the AWS SDK for Ruby.'
