...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-amplifyuibuilder'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Amplify UI Builder'
  spec.description   = 'Official AWS Ruby gem for AWS Amplify UI Builder. This gem is part of the AWS SDK for Ruby.'
