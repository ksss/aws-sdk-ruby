...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-ivs'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon IVS'
  spec.description   = 'Official AWS Ruby gem for Amazon Interactive Video Service (Amazon IVS). This gem is part of the AWS SDK for Ruby.'
