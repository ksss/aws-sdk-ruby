...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-billingconductor'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWSBillingConductor'
  spec.description   = 'Official AWS Ruby gem for AWSBillingConductor. This gem is part of the AWS SDK for Ruby.'
