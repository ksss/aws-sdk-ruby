...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-prometheusservice'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Prometheus Service'
  spec.description   = 'Official AWS Ruby gem for Amazon Prometheus Service. This gem is part of the AWS SDK for Ruby.'
