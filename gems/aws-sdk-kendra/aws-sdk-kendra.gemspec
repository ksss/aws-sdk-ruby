...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-kendra'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - kendra'
  spec.description   = 'Official AWS Ruby gem for AWSKendraFrontendService (kendra). This gem is part of the AWS SDK for Ruby.'
