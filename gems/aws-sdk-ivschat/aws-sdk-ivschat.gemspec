...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-ivschat'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - ivschat'
  spec.description   = 'Official AWS Ruby gem for Amazon Interactive Video Service Chat (ivschat). This gem is part of the AWS SDK for Ruby.'
