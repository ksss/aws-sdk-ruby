...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-iotdeviceadvisor'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWSIoTDeviceAdvisor'
  spec.description   = 'Official AWS Ruby gem for AWS IoT Core Device Advisor (AWSIoTDeviceAdvisor). This gem is part of the AWS SDK for Ruby.'
