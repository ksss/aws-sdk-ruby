...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-backupstorage'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Backup Storage'
  spec.description   = 'Official AWS Ruby gem for AWS Backup Storage. This gem is part of the AWS SDK for Ruby.'
