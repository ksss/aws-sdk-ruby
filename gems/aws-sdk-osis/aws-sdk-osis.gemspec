...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-osis'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon OpenSearch Ingestion'
  spec.description   = 'Official AWS Ruby gem for Amazon OpenSearch Ingestion. This gem is part of the AWS SDK for Ruby.'
