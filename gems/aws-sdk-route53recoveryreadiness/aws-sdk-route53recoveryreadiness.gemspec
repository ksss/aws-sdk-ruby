...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-route53recoveryreadiness'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Route53 Recovery Readiness'
  spec.description   = 'Official AWS Ruby gem for AWS Route53 Recovery Readiness. This gem is part of the AWS SDK for Ruby.'
