...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-internetmonitor'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon CloudWatch Internet Monitor'
  spec.description   = 'Official AWS Ruby gem for Amazon CloudWatch Internet Monitor. This gem is part of the AWS SDK for Ruby.'
