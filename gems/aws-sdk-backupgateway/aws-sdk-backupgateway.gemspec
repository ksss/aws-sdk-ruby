...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-backupgateway'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Backup Gateway'
  spec.description   = 'Official AWS Ruby gem for AWS Backup Gateway. This gem is part of the AWS SDK for Ruby.'
