...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-applicationcostprofiler'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Application Cost Profiler'
  spec.description   = 'Official AWS Ruby gem for AWS Application Cost Profiler. This gem is part of the AWS SDK for Ruby.'
