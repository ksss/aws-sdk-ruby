...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-marketplacedeployment'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Marketplace Deployment Service'
  spec.description   = 'Official AWS Ruby gem for AWS Marketplace Deployment Service. This gem is part of the AWS SDK for Ruby.'
