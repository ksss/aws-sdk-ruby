...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-costoptimizationhub'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Cost Optimization Hub'
  spec.description   = 'Official AWS Ruby gem for Cost Optimization Hub. This gem is part of the AWS SDK for Ruby.'
