...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-sagemakerfeaturestoreruntime'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon SageMaker Feature Store Runtime'
  spec.description   = 'Official AWS Ruby gem for Amazon SageMaker Feature Store Runtime. This gem is part of the AWS SDK for Ruby.'
