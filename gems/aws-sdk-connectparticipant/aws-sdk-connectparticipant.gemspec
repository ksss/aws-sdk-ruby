...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-connectparticipant'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Connect Participant'
  spec.description   = 'Official AWS Ruby gem for Amazon Connect Participant Service (Amazon Connect Participant). This gem is part of the AWS SDK for Ruby.'
