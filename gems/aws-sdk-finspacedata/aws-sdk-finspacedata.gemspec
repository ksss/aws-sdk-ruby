...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-finspacedata'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - FinSpace Data'
  spec.description   = 'Official AWS Ruby gem for FinSpace Public API (FinSpace Data). This gem is part of the AWS SDK for Ruby.'
