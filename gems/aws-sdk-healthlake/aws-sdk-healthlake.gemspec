...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-healthlake'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - HealthLake'
  spec.description   = 'Official AWS Ruby gem for Amazon HealthLake (HealthLake). This gem is part of the AWS SDK for Ruby.'
