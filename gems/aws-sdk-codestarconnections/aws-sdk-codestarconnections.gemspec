...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-codestarconnections'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS CodeStar connections'
  spec.description   = 'Official AWS Ruby gem for AWS CodeStar connections. This gem is part of the AWS SDK for Ruby.'
