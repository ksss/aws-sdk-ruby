...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-qconnect'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Q Connect'
  spec.description   = 'Official AWS Ruby gem for Amazon Q Connect. This gem is part of the AWS SDK for Ruby.'
