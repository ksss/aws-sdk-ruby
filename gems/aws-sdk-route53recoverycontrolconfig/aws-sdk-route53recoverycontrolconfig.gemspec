...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-route53recoverycontrolconfig'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Route53 Recovery Control Config'
  spec.description   = 'Official AWS Ruby gem for AWS Route53 Recovery Control Config. This gem is part of the AWS SDK for Ruby.'
