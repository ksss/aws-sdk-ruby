...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-cloudcontrolapi'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - CloudControlApi'
  spec.description   = 'Official AWS Ruby gem for AWS Cloud Control API (CloudControlApi). This gem is part of the AWS SDK for Ruby.'
