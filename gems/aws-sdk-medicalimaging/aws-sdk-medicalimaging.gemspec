...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-medicalimaging'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Health Imaging'
  spec.description   = 'Official AWS Ruby gem for AWS Health Imaging. This gem is part of the AWS SDK for Ruby.'
