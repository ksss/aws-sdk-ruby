...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-migrationhuborchestrator'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Migration Hub Orchestrator'
  spec.description   = 'Official AWS Ruby gem for AWS Migration Hub Orchestrator. This gem is part of the AWS SDK for Ruby.'
