...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-account'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Account'
  spec.description   = 'Official AWS Ruby gem for AWS Account. This gem is part of the AWS SDK for Ruby.'
