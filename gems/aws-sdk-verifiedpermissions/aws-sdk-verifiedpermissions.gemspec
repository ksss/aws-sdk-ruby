...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-verifiedpermissions'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Verified Permissions'
  spec.description   = 'Official AWS Ruby gem for Amazon Verified Permissions. This gem is part of the AWS SDK for Ruby.'
