...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-docdbelastic'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - DocDB Elastic'
  spec.description   = 'Official AWS Ruby gem for Amazon DocumentDB Elastic Clusters (DocDB Elastic). This gem is part of the AWS SDK for Ruby.'
