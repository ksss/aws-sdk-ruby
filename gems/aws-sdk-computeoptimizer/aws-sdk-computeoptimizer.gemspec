...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-computeoptimizer'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Compute Optimizer'
  spec.description   = 'Official AWS Ruby gem for AWS Compute Optimizer. This gem is part of the AWS SDK for Ruby.'
