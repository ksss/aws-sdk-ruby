...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-lookoutequipment'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - LookoutEquipment'
  spec.description   = 'Official AWS Ruby gem for Amazon Lookout for Equipment (LookoutEquipment). This gem is part of the AWS SDK for Ruby.'
