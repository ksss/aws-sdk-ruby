...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-appconfig'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AppConfig'
  spec.description   = 'Official AWS Ruby gem for Amazon AppConfig (AppConfig). This gem is part of the AWS SDK for Ruby.'
