...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-servicequotas'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Service Quotas'
  spec.description   = 'Official AWS Ruby gem for Service Quotas. This gem is part of the AWS SDK for Ruby.'
