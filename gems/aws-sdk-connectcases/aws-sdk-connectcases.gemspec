...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-connectcases'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - ConnectCases'
  spec.description   = 'Official AWS Ruby gem for Amazon Connect Cases (ConnectCases). This gem is part of the AWS SDK for Ruby.'
