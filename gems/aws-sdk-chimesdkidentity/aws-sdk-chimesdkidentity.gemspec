...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-chimesdkidentity'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Chime SDK Identity'
  spec.description   = 'Official AWS Ruby gem for Amazon Chime SDK Identity. This gem is part of the AWS SDK for Ruby.'
