...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-finspace'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - finspace'
  spec.description   = 'Official AWS Ruby gem for FinSpace User Environment Management service (finspace). This gem is part of the AWS SDK for Ruby.'
