...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-appflow'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Appflow'
  spec.description   = 'Official AWS Ruby gem for Amazon Appflow. This gem is part of the AWS SDK for Ruby.'
