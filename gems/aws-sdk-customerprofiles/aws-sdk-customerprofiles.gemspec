...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-customerprofiles'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Customer Profiles'
  spec.description   = 'Official AWS Ruby gem for Amazon Connect Customer Profiles (Customer Profiles). This gem is part of the AWS SDK for Ruby.'
