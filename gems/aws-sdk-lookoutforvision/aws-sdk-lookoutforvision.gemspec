...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-lookoutforvision'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Lookout for Vision'
  spec.description   = 'Official AWS Ruby gem for Amazon Lookout for Vision. This gem is part of the AWS SDK for Ruby.'
