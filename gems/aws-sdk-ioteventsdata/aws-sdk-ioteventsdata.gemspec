...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-ioteventsdata'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS IoT Events Data'
  spec.description   = 'Official AWS Ruby gem for AWS IoT Events Data. This gem is part of the AWS SDK for Ruby.'
