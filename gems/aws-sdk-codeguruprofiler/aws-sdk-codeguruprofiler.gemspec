...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-codeguruprofiler'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon CodeGuru Profiler'
  spec.description   = 'Official AWS Ruby gem for Amazon CodeGuru Profiler. This gem is part of the AWS SDK for Ruby.'
