...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-braket'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Braket'
  spec.description   = 'Official AWS Ruby gem for Braket. This gem is part of the AWS SDK for Ruby.'
