...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-accessanalyzer'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Access Analyzer'
  spec.description   = 'Official AWS Ruby gem for Access Analyzer. This gem is part of the AWS SDK for Ruby.'
