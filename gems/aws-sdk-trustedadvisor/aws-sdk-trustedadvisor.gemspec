...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-trustedadvisor'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - TrustedAdvisor Public API'
  spec.description   = 'Official AWS Ruby gem for TrustedAdvisor Public API. This gem is part of the AWS SDK for Ruby.'
