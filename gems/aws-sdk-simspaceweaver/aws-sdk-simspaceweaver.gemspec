...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-simspaceweaver'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS SimSpace Weaver'
  spec.description   = 'Official AWS Ruby gem for AWS SimSpace Weaver. This gem is part of the AWS SDK for Ruby.'
