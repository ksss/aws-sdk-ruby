...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-auditmanager'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Audit Manager'
  spec.description   = 'Official AWS Ruby gem for AWS Audit Manager. This gem is part of the AWS SDK for Ruby.'
