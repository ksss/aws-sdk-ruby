...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-timestreamwrite'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Timestream Write'
  spec.description   = 'Official AWS Ruby gem for Amazon Timestream Write (Timestream Write). This gem is part of the AWS SDK for Ruby.'
