...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-transcribestreamingservice'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Transcribe Streaming Service'
  spec.description   = 'Official AWS Ruby gem for Amazon Transcribe Streaming Service. This gem is part of the AWS SDK for Ruby.'
