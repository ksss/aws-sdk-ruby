...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-codeartifact'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - CodeArtifact'
  spec.description   = 'Official AWS Ruby gem for CodeArtifact. This gem is part of the AWS SDK for Ruby.'
