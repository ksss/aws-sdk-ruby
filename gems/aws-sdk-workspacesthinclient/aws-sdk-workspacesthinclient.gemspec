...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-workspacesthinclient'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon WorkSpaces Thin Client'
  spec.description   = 'Official AWS Ruby gem for Amazon WorkSpaces Thin Client. This gem is part of the AWS SDK for Ruby.'
