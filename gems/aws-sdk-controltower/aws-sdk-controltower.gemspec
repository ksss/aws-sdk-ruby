...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-controltower'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Control Tower'
  spec.description   = 'Official AWS Ruby gem for AWS Control Tower. This gem is part of the AWS SDK for Ruby.'
