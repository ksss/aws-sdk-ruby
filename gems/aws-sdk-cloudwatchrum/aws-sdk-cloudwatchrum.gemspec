...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-cloudwatchrum'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - CloudWatch RUM'
  spec.description   = 'Official AWS Ruby gem for CloudWatch RUM. This gem is part of the AWS SDK for Ruby.'
