...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-oam'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - CloudWatch Observability Access Manager'
  spec.description   = 'Official AWS Ruby gem for CloudWatch Observability Access Manager. This gem is part of the AWS SDK for Ruby.'
